...
namespace WMB.MaratonaXamarin.Droid.Services
{
    ...
    {
        public static string[] SENDER_IDS = new string[] { "654434845319" };
    }
    ...
    public class GcmService : GcmServiceBase
    {
        ...
        {
            Log.Error("PushHandlerBroadcastReceiver", "OnUnRegistered id" + registrationId);
        }
        protected override void OnError(Context context, string errorId)
        {
            Log.Error("PushHandlerBroadcastReceiver", "OnError id" + errorId);
        }
